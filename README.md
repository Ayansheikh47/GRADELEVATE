...
GradElevate helps students navigate career selection, skill development and job readiness through personalized AI-powered recommendations, skill gap analysis and resume feedback.
...
```bash
git clone https://github.com/yourusername/gradelevate.git
cd gradelevate/gradelevate-backend
```

**2. Create PostgreSQL database**
```sql
CREATE DATABASE gradelevate_db;
```
...
GradElevate uses **Gemini 2.5 Flash** via REST API for three features:
