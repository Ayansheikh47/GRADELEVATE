...
import com.gradelevate.gradelevate_backend.dto.SmartRecommendationDTO;
import com.gradelevate.gradelevate_backend.dto.UserProfileDTO;
import com.gradelevate.gradelevate_backend.entity.*;
...
public class SmartOnboardingService {
    ...
    private int matchScore(List<String> userTags,
                           ...
                           int maxPoints) {
        if (userTags.isEmpty() || careerTags.isEmpty()) return 0;
