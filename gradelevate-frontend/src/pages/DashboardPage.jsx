...
import {
  Briefcase, BookOpen, Cpu, FileText,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4
        ...
        <h1 className="text-xl font-bold text-indigo-600">GradElevate</h1>
          ...
          {navItems.map((item) => (
            <Link
              ...
              className="flex items-center gap-1.5 text-sm text-gray-600
                hover:text-indigo-600 font-medium transition"
            >
              <item.icon size={16} />
              {item.label}
            </Link>
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className={`text-2xl font-bold
                      ${getScoreColor(career.score)}`}>
                      {career.score}%
                    </span>
                    <span className={`text-xs font-medium px-2.5 py-1
                      rounded-full ${getDemandColor(career.demandLevel)}`}>
                  ...
                  <h4 className="font-bold text-gray-800 text-base
                    group-hover:text-indigo-600 transition mb-1">
                    {career.title}
                  </h4>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                ...
                desc: 'Learn what skills you need',
                icon: BookOpen,
                color: 'bg-blue-600',
                path: '/skills'
              },
              ...
              <div
                ...
                className="bg-white rounded-xl p-5 shadow-sm border
                  border-gray-100 hover:shadow-md transition cursor-pointer
                  group"
              >
